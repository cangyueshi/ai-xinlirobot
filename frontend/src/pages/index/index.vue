<template>
  <view class="container">
    ...
    <view class="menu-list">
      <view class="menu-item" v-if="isVisitor" @click="goPage('/pages/chat/chat')">
        <text class="menu-icon">💬</text>
        <text class="menu-text">开始 AI 对话</text>
        <text class="menu-arrow">›</text>
      </view>

      <view class="menu-item" v-if="isVisitor" @click="goPage('/pages/chat/history')">
        <text class="menu-icon">�</text>
        <text class="menu-text">对话记录</text>
        <text class="menu-arrow">›</text>
      </view>
      ...
      <view class="menu-item" v-if="isCounselor" @click="goPage('/pages/chat/alerts')">
        <text class="menu-icon">🔔</text>
...
.container { padding: 20px 15px; min-height: 100vh; }
.user-card { display: flex; align-items: center; background: #fff; padding: 20px; border-radius: 12px; margin-bottom: 20px; box-shadow: 0 2px 8px rgba(0,0,0,0.06); }
.avatar { width: 56px; height: 56px; border-radius: 50%; background: #409eff; display: flex; align-items: center; justify-content: center; margin-right: 15px; }
.avatar-text { font-size: 24px; color: #fff; font-weight: bold; }
.user-info .name { display: block; font-size: 18px; font-weight: bold; color: #2c3e50; margin-bottom: 4px; }
.role-tag { display: inline-block; font-size: 12px; color: #409eff; background: #ecf5ff; padding: 2px 10px; border-radius: 10px; }
.menu-list .menu-item { display: flex; align-items: center; background: #fff; padding: 16px 18px; margin-bottom: 1px; border-radius: 8px; }
.menu-icon { font-size: 20px; margin-right: 14px; }
.menu-text { flex: 1; font-size: 16px; color: #303133; }
.menu-arrow { font-size: 20px; color: #c0c4cc; }
